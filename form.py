...
def save():
    ...
    pdf.cell(35, 6, txt="Total Bags in AKEs: ", ln=0, align="L")
    pdf.cell(35, 6, txt=total_xq_in_ake_info, ln=1, align="L")
    pdf.cell(35, 6, txt=registration_info, ln=1, align="L")
    pdf.cell(35, 6, txt=registration_info, ln=1, align="L")
    pdf.cell(35, 6, txt=registration_info, ln=1, align="L")
    pdf.ln()
